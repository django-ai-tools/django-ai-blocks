...
class PivotBlock(BaseBlock, FilterResolutionMixin):
    ...
    def build_columns_and_rows(self, user, filter_values):
        ...
        try:
            from django_ai_blocks.permissions.checks import filter_viewable_queryset as filter_viewable_queryset_generic
            from django_ai_blocks.workflow.permissions import filter_viewable_queryset_state
