...
from django_ai_blocks.workflow.permissions import (
...
from django_ai_blocks.permissions.checks import (
...
from django_ai_blocks.blocks.services.field_rules import get_field_display_rules
from django_ai_blocks.blocks.services.column_config import get_user_column_config
...
class TableBlock(BaseBlock, FilterResolutionMixin):
    ...
    def get_column_defs(self, user, column_config=None):
        ...
        try:
            from django_ai_blocks.blocks.services.column_config import get_model_fields_for_column_config
            try:
