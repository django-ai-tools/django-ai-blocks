...
from django_ai_blocks.blocks.views import table as table_views
from django_ai_blocks.blocks.views import chart as chart_views
from django_ai_blocks.blocks.views import pivot as pivot_views
from django_ai_blocks.blocks.views.pivot_config import PivotConfigView
from django_ai_blocks.blocks.views.pivot_filter_config import PivotFilterConfigView
from django_ai_blocks.blocks.views.inline_edit import InlineEditView
from django_ai_blocks.blocks.views.column_config import ColumnConfigView
from django_ai_blocks.blocks.views.filter_config import FilterConfigView, ChartFilterConfigView
from django_ai_blocks.blocks.views.filter_choices import FilterChoicesView
from django_ai_blocks.blocks.views.filter_layout import FilterLayoutView, AdminFilterLayoutView
