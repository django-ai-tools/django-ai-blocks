...
from django_ai_blocks.blocks.registry import block_registry
from django_ai_blocks.layout.models import Layout, LayoutBlock, LayoutFilterConfig
...
from django_ai_blocks.layout.forms import (
    LayoutForm,
    AddBlockForm,
    LayoutFilterConfigForm,
)

from django_ai_blocks.layout.mixins import LayoutFilterSchemaMixin, LayoutAccessMixin
...
class LayoutBlockRenderView(LoginRequiredMixin, LayoutAccessMixin, LayoutFilterSchemaMixin, View):
    ...
    def get(self, request, username, slug, id, *args, **kwargs):
        ...
        pref_name = (lb.preferred_filter_name or "").strip()
        if pref_name:
            from django_ai_blocks.blocks.models.block_filter_config import BlockFilterConfig as BFC
        ...
        pref_col = (lb.preferred_column_config_name or "").strip()
        if pref_col:
            from django_ai_blocks.blocks.models.block_column_config import BlockColumnConfig as BCC
