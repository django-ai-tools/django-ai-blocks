    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('block', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='django_ai_blocks.block', unique=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('block', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='django_ai_blocks.block')),
                ('layout', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blocks', to='django_ai_blocks.layout')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('layout', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='filter_configs', to='django_ai_blocks.layout')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dest_state', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='transitions_to', to='django_ai_blocks.state')),
                ('source_state', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='transitions_from', to='django_ai_blocks.state')),
            ],
        ),
        migrations.CreateModel(
            name='TransitionLog',
            fields=[
                ...
                ('from_state', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='django_ai_blocks.state')),
                ('to_state', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='django_ai_blocks.state')),
                ('transition', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='django_ai_blocks.transition')),
        ...
        migrations.AddField(
            ...
            name='workflow',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='transitions', to='django_ai_blocks.workflow'),
        ),
        migrations.AddField(
            model_name='state',
            name='workflow',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='states', to='django_ai_blocks.workflow'),
        ),
        migrations.CreateModel(
